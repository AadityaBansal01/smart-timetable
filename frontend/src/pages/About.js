  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 px-6 py-12">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-bold mb-4 text-blue-700 dark:text-blue-400">About Smart Timetable</h1>
        ...
        <ul className="text-left list-disc list-inside mb-8 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Project Vision</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Credits</h2>
