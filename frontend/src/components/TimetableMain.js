  ...
  return (
    <div className="p-4 bg-gray-100 dark:bg-gray-900 min-h-screen">
      ...
      <div className="mb-4 flex items-center gap-4">
        <label className="font-semibold text-gray-900 dark:text-white">Your timetables:</label>
        <select
        ...
        <button
          ...
          className="bg-red-500 dark:bg-red-600 text-white px-3 py-1 rounded hover:bg-red-600 dark:hover:bg-red-700 transition-colors"
        >
          Delete
        </button>
        ...
        <div className="ml-4">
          <input
            ...
            className="border dark:border-gray-600 p-2 rounded mr-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
          />
          <button
            onClick={async () => {
            ...
            className="bg-yellow-500 dark:bg-yellow-600 text-white px-3 py-1 rounded hover:bg-yellow-600 dark:hover:bg-yellow-700 transition-colors"
          >
            Rename
          </button>
        </div>
      ...
      <h2 className="text-xl font-bold mt-6 mb-2 text-gray-900 dark:text-white">Class-wise Editable Timetable</h2>
      <TimetableGrid
        timetable={timetable}
        classes={classes}
      ...
      <div className="mt-4">
        <button onClick={exportCSV} className="bg-blue-500 dark:bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-600 dark:hover:bg-blue-700 transition-colors">
        ...
        <button
          ...
          className="bg-green-500 dark:bg-green-600 text-white px-4 py-2 rounded ml-2 hover:bg-green-600 dark:hover:bg-green-700 transition-colors"
        >
          Save Timetable
        </button>

        {saveStatus && <p className="text-sm mt-2 text-gray-700 dark:text-gray-300">{saveStatus}</p>}
      </div>
    </div>
  );
}
